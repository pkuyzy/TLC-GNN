...
if __name__ == "__main__":
    #type = 'LP'
    type = 'NC'
    d_names = ['ZINC']#'ogbg-molhiv']#'COLLAB']#, 'ENZYMES', 'PROTEINS', 'COLLAB', 'IMDB-BINARY' ,'REDDIT-BINARY']
    filts = ['hks_10', 'hks_0.1', 'degree']
    #filts = ['hks_10']
    epochs = 20
    learning_rate = 0.002
    weight_decay = 0.01
    ...
    for epoch in range(epochs):
        ...
        for d_name in d_names:
            for filt in filts:
               ...
               # train_sample = random.sample(train_sample, int(num_sample * 0.1))

                #test()
                train_loss_0, train_loss_PI, train_xy0, train_xd0, train_yd0= train()
                PD0_loss, PI_loss, test_xy0, test_xd0, test_yd0 = test()

                if filt == 'degree' and save_model and model_type == 'GAT' and new_node_feat:
