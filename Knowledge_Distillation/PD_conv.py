...
class PDConv(MessagePassing):
    ...
    def __init__(self, in_channels: int, out_channels: int, double_input:bool  = False, new_node_feat: bool = True,
                 improved: bool = False, cached: bool = False,
                 add_self_loops: bool = True, normalize: bool = True,
                 bias: bool = True, **kwargs):

        super(PDConv, self).__init__(aggr='add', **kwargs)
    ...
    def aggregate(self, inputs: Tensor, index: Tensor,
        ...
        if ptr is not None:
            ...
            # new
            return torch.cat((scatter(inputs, index, dim=self.node_dim, dim_size=dim_size, reduce='sum'), scatter(inputs, index, dim=self.node_dim, dim_size=dim_size, reduce='min')), dim = 1)
